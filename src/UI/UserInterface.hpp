...
namespace UI
{
	...
	extern unsigned int GetThumbnailTargetWidth();
	extern unsigned int GetThumbnailTargetHeight();
	extern void UpdateJobLayer(unsigned int layer);
	extern void UpdateJobNumLayers(unsigned int layers);
	extern void UpdateCurrentMoveRequestedSpeed(float value);
	extern void UpdateCurrentMoveTopSpeed(float value);
	extern void UpdateCurrentMoveExtrusionRate(float value);
	...
	extern void UpdateColdExtrudeTemperature(float value);
	extern void UpdateColdRetractTemperature(float value);
	...
	extern void UpdatePressureAdvance(size_t index, float value);
	extern void UpdateStatusCurrentObject(int objectIndex);
	extern void UpdateStatusObjectName(size_t objectIndex, const char *name);
	extern void UpdateStatusObjectCancelled(size_t objectIndex, bool cancelled);
	extern void BeginStatusObjectCoordinate(size_t objectIndex, bool xAxis);
	extern void ClearStatusObjectCoordinate(size_t objectIndex, bool xAxis);
	extern void UpdateStatusObjectCoordinate(size_t objectIndex, bool xAxis, float value);
	extern void UpdateStatusObjectCount(size_t count);
	...
	extern void EnableStatusJobNavButtons(bool scrollEarlier, bool scrollLater, bool parentDir);
	extern void UpdateStatusJobFileButton(unsigned int buttonIndex, const char * _ecv_array null text, const char * _ecv_array null param);
	...
	extern void SetAxisMin(size_t index, float val);
